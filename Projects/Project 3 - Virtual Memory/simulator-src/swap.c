 ...
 * 
 * @param queue pointer to the swap queue
 * @param swap_id id of the swap entry to be dequeued
 */
void swap_queue_dequeue(swap_queue_t *queue, swap_id_t swap_id)
{
 ...
 * 
 * @param queue pointer to the swap queue
 * @param swap_id id of the swap entry to be found
 * 
 * @return pointer to the found swap_entry
 */
swap_entry_t *swap_queue_find(swap_queue_t *queue, swap_id_t swap_id)
{
    swap_entry_t *curr = queue->head;
